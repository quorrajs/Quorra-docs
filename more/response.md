...
rendered during that request / response cycle (if any). Otherwise, this property is identical to [app.locals](/docs/1.0.0/more/miscellaneous.md#application-locals).
