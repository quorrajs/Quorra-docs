...
When the [trust proxy setting](/docs/{{version}}/more/miscellaneous.md#quorra-behind-proxies) is set to a non-falsey value, the value of the
...
When the [trust proxy setting](/docs/{{version}}/more/miscellaneous.md#quorra-behind-proxies) is set to a non-falsey value, the
value is
...
When the [trust proxy setting](/docs/{{version}}/more/miscellaneous.md#quorra-behind-proxies) is set to a non-falsey value, this property
...
req.input.flash();
```
> **Note:** You may flash other data across requests using the [session](/docs/{{version}}/middlewares/session.md) middleware methods.
